...
class TestCreateEmberApp:
    ...
    def test_create_ember_app_with_default_config(
        self,
        mock_usage_service,
        mock_initialize_registry,
        mock_init_api_keys,
        mock_create_config_manager,
        mock_get_logger,
    ):
        ...
        mock_create_config_manager.assert_called_once_with(
            config_path=None, logger=mock_logger
        )
        ...
        mock_initialize_registry.assert_called_once_with(
            config_manager=mock_config_manager, auto_discover=True
        )
    ...
    def test_create_ember_app_with_custom_config(
        ...
        mock_create_config_manager.assert_called_once_with(
            config_path=custom_config, logger=mock_logger
        )
